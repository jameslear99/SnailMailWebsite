...
> **Firebase App Hosting:** This app lives at `starters/nextjs/basic` in the SnailMailWebsite
> repo. Set the App Hosting backend **root directory** to `starters/nextjs/basic` when
> connecting GitHub.
